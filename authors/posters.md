...
<div class="row">
	<div class="col-xl-8 col-lg-7 col-md-6 col-12">
		...
		<p>
			Accepted Poster Papers will be archived in the <a href="http://dl.acm.org/" title="The ACM Digital Library">ACM Digital Library</a> and auth  will be given the opportunity to present their poster during a dedicated poster session. At least one author of each accepted poster must register for the conference.
		</p>
		<h2>Any questions?</h2>
		<p>
