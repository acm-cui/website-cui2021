...
module Jekyll
  ...
  class ProgrammeDaysLastModifiedAtTag < Liquid::Tag
    def initialize(tag_name, format, tokens)
      super
      @data_path          = '_data/days.yml'
...
Liquid::Template.register_tag('programme_days_last_modified_at', Jekyll::ProgrammeDaysLastModifiedAtTag)
