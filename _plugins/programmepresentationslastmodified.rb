...
module Jekyll
  ...
  class ProgrammePresentationsLastModifiedAtTag < Liquid::Tag
    def initialize(tag_name, format, tokens)
      super
      @data_path          = '_data/presentations.yml'
...
Liquid::Template.register_tag('programme_presentations_last_modified_at', Jekyll::ProgrammePresentationsLastModifiedAtTag)
